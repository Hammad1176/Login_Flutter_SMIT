...
class _GridScreenState extends State<GridScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (getProvider.searchFilter.isEmpty) {
      return GridView.builder(
          itemCount:
              BuissnesList.productList[getProvider.selectedCategory].length - 1,
          ...
          itemBuilder: (BuildContext, getIndex) {
            final data = BuissnesList.productList[getProvider.selectedCategory]
                [getIndex];
            // print("build grid");
            return Container(
      ...
      return getProvider.filterIsNotMatch
          ? notMatchList(getProvider)
          : filterList(getProvider.searchFilter, context);
    } // Display filtered list based on search
  }
}

notMatchList(CategoryProvider getprovider) {
  print("get data bool ${getprovider.filterIsNotMatch}");
  return const Text("search item not match with list ");
}
